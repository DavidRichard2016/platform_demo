...
function SendMail($to,$title,$message)
{
	...
	$mail->Username = "tianlin@douyu.tv"; //邮箱名
	$mail->Password = "889136tlAPP"; //邮箱密码

	//$mail->AddReplyTo("18362957599@163.com","mckee");//回复地址 
	$mail->From = "tianlin@douyu.tv";
	$mail->FromName = "www.douyu.com"; 
 
	$to = $to;
	$mail->AddAddress('tianlin@douyu.tv','linda');
    $mail->AddAddress('2214232608@qq.com','linda');
	//$mail->AddCC("tianlin@douyu.tv",'hello');
	$mail->Subject = $title; 
	$mail->Body = $message; 
